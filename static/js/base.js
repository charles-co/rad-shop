...
$(window).scroll(function() {
    if ($(document).scrollTop() > 80) {
        ...
        $('#left-buttons-mobile #cart-icon').removeClass('text-dark').addClass('text-white');
        $('#left-buttons-mobile #search-button-mobile').removeClass('text-dark').addClass('text-info');
        ...
        $('#left-buttons-mobile #cart-icon').removeClass('text-white').addClass('text-dark');
        $('#left-buttons-mobile #search-button-mobile').removeClass('text-info').addClass('text-dark');
